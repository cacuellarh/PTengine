            ...
            <body>
                <div class="main">
                    <div class="container">
                        ...
                        <h1>¡Hemos detectado un cambio en el precio de tu producto '''+ str(ins.ImageTrackDescription) +'''!</h1>
...
<body>
    <div class="main">
        <table>
            <tr>
                <td><img class="logo" src="/template/img/img/logo_dark_purple.png" alt="TrackMyPrice"></td>
            </tr>
            <tr>
                <td><h1>Verifica tu email para comenzar a usar TrackMyPrice</h1></td>
            </tr>
            <tr>
                <td><p>¡Hola! Para comenzar el monitoreo, por favor verifica tu dirección de email y producto('''+ productDescription.upper()+''').</p></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><a class="link" "'''+ str(base)+'''/token_confirm/'''+ str(token_email)+'''">'''+ str(base)+'''/token_confirm/'''+ str(token_email)+'''</a></td>
            </tr>
            <tr>
                <td><p>Si tienes preguntas o necesitas asistencia de nuestro equipo de Soporte, por favor <a class="link" href="https://trackmyprice.co/contact">contáctanos</a>.</p></td>
            </tr>
        </table>
        <div class="info">
            <p>Has recibido este email porque estás registrado en TrackMyPrice. Consulta nuestra <a href="https://trackmyprice.co/privacy" target="_blank">política de privacidad</a> para más información.</p>
